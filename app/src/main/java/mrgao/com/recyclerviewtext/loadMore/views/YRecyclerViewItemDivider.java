...
public class YRecyclerViewItemDivider extends RecyclerView.ItemDecoration {
    ...
    public YRecyclerViewItemDivider(Context context, int orientation) {
    ...
    public YRecyclerViewItemDivider(int orientation, int color, int lineHeight) {
        mOrientation = orientation;
